...
@Tag(name = "Hostel Management", description = "Hostels, rooms, beds, allocations, and occupancy records.")
public class HostelController {

	private static final String MODULE = "HOSTEL";

	private final ModuleRecordControllerSupport support;

	@GetMapping("/{recordType}")
	@PreAuthorize("hasAuthority('HOSTEL_READ')")
	@Operation(summary = "List hostel records")
	...
	@Operation(summary = "Create hostel record")
