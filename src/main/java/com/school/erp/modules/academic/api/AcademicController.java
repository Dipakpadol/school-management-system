...
@Tag(name = "Academic Management", description = "Academic years, classes, sections, subjects, mappings, and timetable setup.")
public class AcademicController {
	...
	@Operation(summary = "List academic records")
	...
	@PreAuthorize("hasAuthority('ACADEMIC_READ')")
	@Operation(summary = "Get academic setup counts")
